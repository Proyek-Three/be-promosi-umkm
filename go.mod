module github.com/Proyek-Three/be-promosi-umkm

go 1.23.3

require (
	github.com/Proyek-Three/bp-promosi-umkm v0.0.0-20250112160306-db392ff8e4ba
...
require (
	...
	github.com/whatsauth/whatsauth v0.1.82 // indirect
	...
	go.mau.fi/whatsmeow v0.0.0-20241121132808-ae900cb6bee4 // indirect
